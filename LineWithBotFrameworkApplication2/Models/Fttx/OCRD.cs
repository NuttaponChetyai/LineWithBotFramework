...
namespace LineWithBotFrameworkApplication2.Models.Fttx
{
    ...
    public partial class OCRD
    {
        ...
        public string U_StmAddr { get; set; }
        public string U_StmBlck { get; set; }
        public string U_StmCity { get; set; }
        public string U_StmZipC { get; set; }
        public string U_Bphone { get; set; }
        public Nullable<System.DateTime> U_SDate { get; set; }
        public string U_StmCnty { get; set; }
        public string U_TId { get; set; }
        public string U_InsTel { get; set; }
        public Nullable<decimal> U_Lat { get; set; }
        public Nullable<decimal> U_Lon { get; set; }
        public string U_Title { get; set; }
        public string U_RegNo { get; set; }
        public string U_Email2 { get; set; }
        public string U_BranchNo { get; set; }
        public string U_Cellular2 { get; set; }
        public string U_SmsW { get; set; }
        public string U_BPType { get; set; }
    }
}
