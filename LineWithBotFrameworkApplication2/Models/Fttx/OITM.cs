...
namespace LineWithBotFrameworkApplication2.Models.Fttx
{
    ...
    public partial class OITM
    {
        ...
        public string U_PmID { get; set; }
        public string U_SpID { get; set; }
        public Nullable<short> U_Order { get; set; }
        public string U_Admin { get; set; }
        public string U_Dealer { get; set; }
        public Nullable<short> U_Online { get; set; }
        public string U_DvType { get; set; }
        public string U_PackType { get; set; }
        public Nullable<short> U_Speed { get; set; }
        public string U_DefaultPeriod { get; set; }
        public string U_OthServType { get; set; }
        public string U_Vendor { get; set; }
        public Nullable<decimal> U_VendorPrice { get; set; }
        public Nullable<decimal> U_EPrice { get; set; }
        public string U_ChangeContract { get; set; }
        public Nullable<decimal> U_IspPrice { get; set; }
        public string U_AddonItem { get; set; }
        public Nullable<int> U_PrimeTimePortion { get; set; }
        public string U_SubPackType { get; set; }
        public Nullable<short> U_ContractStatus { get; set; }
        public Nullable<decimal> U_SharingPrice { get; set; }
    }
}
