...
namespace LineWithBotFrameworkApplication2.Models.Fttx
{
    ...
    public partial class OINV
    {
        ...
        public string U_PStatus { get; set; }
        public string U_UsrW { get; set; }
        public string U_EStatus { get; set; }
        public Nullable<System.DateTime> U_BankDate { get; set; }
        public string U_BankInfo { get; set; }
        public string U_ProID { get; set; }
        public string U_ProDtail { get; set; }
        public Nullable<int> U_AdvPd { get; set; }
        public Nullable<int> U_PrdNo { get; set; }
        public Nullable<decimal> U_WhTax { get; set; }
        public string U_TaxStatus { get; set; }
        public string U_SpcDis { get; set; }
        public string U_SpcRemark { get; set; }
        public string U_RefReceipt { get; set; }
        public Nullable<System.DateTime> U_CallDate { get; set; }
        public string U_CallStatus { get; set; }
        public string U_CallPerson { get; set; }
        public Nullable<System.DateTime> U_BillFrom { get; set; }
        public Nullable<System.DateTime> U_BillTo { get; set; }
        public string U_SCallID { get; set; }
        public Nullable<short> U_PrintNo { get; set; }
        public string U_LoanName { get; set; }
        public string U_ReturnName { get; set; }
        ...
        public Nullable<short> U_SentStatus { get; set; }
    }
}
